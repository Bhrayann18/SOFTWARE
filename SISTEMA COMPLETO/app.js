...
function agregarAlCarritoClicked(event){
    ...
    TALLA.addEventListener('change', () => {
        let valorOption = TALLA.value;
        console.log(valorOption);
  
        var optionSelect = TALLA.options[TALLA.selectedIndex];
      ...
      let  inputResult = document.querySelector('#result').value=(optionSelect.text +' - ' + optionSelect.value);
        ...
        const capa = document.querySelector('#capaTALLA');
        capa.textContent = `Mi Talla es: ${valorOption}`;
      });
